...
- Display name (pseudo) — chosen by you
- Favorite team and driver (F1 + MotoGP) — chosen by you
- Sport preference (F1 / MotoGP)
- Language preference
- Account creation date

### 2.2 Activity data (generated while using the app)
- Race predictions (P1/P2/P3) — linked to your account
- League memberships and league join codes
- Poll/vote responses
- App usage logs (anonymized) — to detect crashes and improve performance

### 2.3 Device data (collected automatically)
- Device type and OS version
- App version
- Approximate region (for language detection and EU/UK consent banner)
- AdMob advertising identifier (only if you consent — see section 5)
...
| Logs / crash reports | Legitimate interest (Art. 6.1.f) — app quality |
| Personalized ads | Consent (Art. 6.1.a) — see section 5 |
...
On first launch, you'll see a **consent form** (Google UMP) asking whether you allow:
- Personalized ads (based on your AdMob ID)
- Non-personalized ads (contextual only)

You can change your choice anytime in **Profile → Privacy & Data → Manage ad consent**.

### iOS 14.5+ users
You'll see Apple's **App Tracking Transparency (ATT)** prompt asking permission to use your IDFA. Choosing "Ask App Not to Track" disables personalized ads.
...
| **Google** | Sign-In with Google + AdMob | USA / Ireland | Email + advertising ID (with consent) |
...
- **Access** your data — use the in-app export (Profile → Privacy & Data → Export my data)
- **Rectify** inaccurate data — edit in your profile
- **Erase** your account — use the in-app deletion (Profile → Privacy & Data → Delete my account)
- **Portability** — JSON export available in-app
- **Object** to processing — withdraw consent in Profile → Manage ad consent
- **Restrict** processing — contact us
- **Lodge a complaint** with your data protection authority (CNIL in France, ICO in UK, EDÖB in Switzerland)
